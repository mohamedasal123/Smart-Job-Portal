      ...
      <main className="flex-grow flex items-center justify-center p-gutter">
        <div className="max-w-2xl w-full text-center flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-stack-md justify-center w-full max-w-md">
            <Link className="inline-flex items-center justify-center px-gutter py-stack-sm rounded-lg bg-[#2563EB] text-on-primary font-body-lg text-body-lg font-bold hover:opacity-90 transition-opacity w-full sm:w-auto shadow-[0px_4px_20px_rgba(15,23,42,0.05)]" to={ROUTES.LOGIN}>
